  ...
  <div className="sidebar">
    ...
    <div className="control-group">
      ...
      <select id="asteroid-select" onChange={e => onSelect(e.target.value)}>
        <option>-- Choose an Asteroid --</option>
      ...
      try {
        ...
        const asteroidList = Object.values(nearEarthObjects)
          ...
          .map(a => ({
            id: a.id,
            name: a.name,
            diameter: a.estimated_diameter.kilometers.estimated_diameter_mean,
            velocity: parseFloat(a.close_approach_data[0].relative_velocity.kilometers_per_second),
            miss_distance: parseFloat(a.close_approach_data[0].miss_distance.kilometers),
          }))
